        ...
        window.onload = fun() {
            ...
            document.getElementById("delSelected").onclick = function (ev) {
                ...
                if (confirm("您确定要删除嘛？")) {
                    ...
                    //判断是否有条目被选中,无选中则不返回，有选中则返回【防止报空指针异常】
                    var flag = false;
                    //判断是否选中
...
<div class="container">
    ...
    <div style="float: right;margin: 5px;">
        ...
        <a class="btn btn-primary" href="javascript:void(0);" name="delSelected">删除选中</a>
    </div>

    <form id="form" action="${pageContext.request.contextPath}/delUserServlet">
